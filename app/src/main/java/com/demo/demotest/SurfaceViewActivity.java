 ...
 *  
 */    
public class SurfaceViewActivity extends Activity implements OnCompletionListener,OnErrorListener,OnInfoListener,    
    ...
    public void onCreate(Bundle savedInstanceState){    
        ...
        this.setContentView(R.layout.activity_video_surface);    
        ...
        String dataPath = "http://123.57.64.222:6002/upload/video/20160307052818.mp4";    
        try {    
